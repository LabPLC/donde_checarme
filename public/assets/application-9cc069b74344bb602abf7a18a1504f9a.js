...
(function() {
  var card, create_cards, create_marker, delete_markers, display_on_map, error, gm_init, infowindow, load_from_position, load_points, moviendo_mapa, set_marker_map, success;
  ...
  card = function(point) {
    var direccion_centro, div_card_centro, horario_centro, nombre_centro, telefonos_centro;
