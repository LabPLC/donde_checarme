...
(function() {
  var create_marker, delete_markers, display_on_map, error, gm_init, infowindow, load_from_position, load_points, moviendo_mapa, set_marker_map, success;
  ...
  create_marker = function(point, map) {
    ...
    content_string = '<div class="centro_info"' + '<div class="centro_encabezado">' + '<h1>' + point.nombre + '</h1>' + '</div>' + '<div class="centro_content"' + '<strong>Teléfono:</strong>' + '<p>' + point.telefono + '</p>' + '</div>';
  ...
  moviendo_mapa = function() {
    ...
    delete_markers(window.map);
    return load_from_position(window.map, centro_pos.lat(), centro_pos.lng());
  };
