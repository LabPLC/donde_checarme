...
(function() {
  var ajaxtrue, card, create_cards, create_marker, delete_markers, display_on_map, error, gm_init, infowindow, load_from_position, load_points, moviendo_mapa, set_marker_map, success;
  ...
  load_points = function(map) {
    var callback;
    callback = function(data) {
      return display_on_map(data, map);
    };
    return $.get('/hospitales.json', {}, callback, 'json');
  };
  ...
  create_marker = function(point, map) {
    ...
    content_string = '<div class="centro_info">' + '<div class="centro_encabezado">' + '<h3>' + point.nombre + '</h3>' + '</div>' + '<div class="centro_content"' + '<h4>Teléfonos:</h4>' + '<p>' + point.telefono + '</p>' + '<h4> Horario:</h4>' + '<p>' + point.horario + '</p>' + '</div>' + '</div>';
  ...
  card = function(point) {
    ...
    return div_card_centro = "<div class='card'>" + nombre_centro + direccion_centro + horario_centro + telefonos_centro + hacer_cita + "</div>";
  };
